...
* [Capa](https://github.com/fireeye/capa) ⭐ 6,180 | 🐛 299 | 🌐 Python | 📅 2026-09-08 - An open-source tool to identify capabilities in executable files.
* [DetectionLab](https://github.com/clong/DetectionLab/) ⭐ 5,020 | 🐛 42 | 🌐 HTML | 📅 2024-07-06 - Vagrant & Packer scripts to build a lab environment complete with security tooling and logging best practices.
* [ProcMon for Linux](https://github.com/Sysinternals/ProcMon-for-Linux) ⭐ 4,735 | 🐛 33 | 🌐 C | 📅 2026-09-10
* [Intel Owl](https://github.com/intelowlproject/IntelOwl) ⭐ 4,712 | 🐛 72 | 🌐 Python | 📅 2026-09-10 - An Open Source Intelligence, or OSINT solution to get threat intelligence data about a specific file, an IP or a domain from a single API at scale.
...
* [MITRE ATT\&CK Navigator](https://mitre.github.io/attack-navigator/enterprise/) ([source code](https://github.com/mitre-attack/attack-navigator) ⭐ 2,459 | 🐛 78 | 🌐 TypeScript | 📅 2026-09-11) - The ATT\&CK Navigator is designed to provide basic navigation and annotation of ATT\&CK matrices, something that people are already doing today in tools like Excel.
...
* [Splunk Security Content](https://github.com/splunk/security_content) ⭐ 1,690 | 🐛 14 | 🌐 Python | 📅 2026-09-12 Splunk-curated detection content that can easily be used accross many SIEMs (see Uncoder Rule Converter.)
...
* [Shuffle](https://github.com/Shuffle/Shuffle) ⭐ 2,432 | 🐛 492 | 🌐 JavaScript | 📅 2026-09-10: A general purpose security automation platform.
...
* [Sublime](https://github.com/sublime-security/sublime-platform) ⭐ 269 | 🐛 17 | 🌐 Shell | 📅 2026-09-11: An open platform for detection, response, and threat hunting in email environments. Sublime lets you write advanced detections as code to alert and remediate threats like phishing in real-time.

### Endpoint Monitoring

* [osquery](https://osquery.io) ([github](https://github.com/osquery/osquery) ⭐ 23,562 | 🐛 659 | 🌐 C++ | 📅 2026-09-09) - SQL powered operating system instrumentation, monitoring, and analytics
* [WAZUH](https://github.com/wazuh/wazuh) ⭐ 16,843 | 🐛 3,087 | 🌐 C++ | 📅 2026-09-12 - An open-source security platform
...
* [Velociraptor](https://github.com/Velocidex/velociraptor) ⭐ 4,242 | 🐛 80 | 🌐 Go | 📅 2026-09-10 - Endpoint visibility and collection tool
* [Sysmon for Linux](https://github.com/Sysinternals/SysmonForLinux) ⭐ 2,159 | 🐛 41 | 🌐 C | 📅 2026-09-10
...
* [auditd configuration](https://github.com/Neo23x0/auditd) ⭐ 1,910 | 🐛 18 | 🌐 Shell | 📅 2026-05-04
...
* [ntopng](https://github.com/ntop/ntopng) ⭐ 8,151 | 🐛 303 | 🌐 Lua | 📅 2026-09-12 - A web-based network traffic monitoring tool
* [Zeek](https://github.com/zeek/zeek) ⭐ 7,959 | 🐛 256 | 🌐 C++ | 📅 2026-09-11 (formerly Bro) - A network security monitoring tool
* [Arkime](https://github.com/arkime/arkime) ⭐ 7,463 | 🐛 37 | 🌐 C | 📅 2026-09-11) - A large scale and open source full packet capture and search tool
* [Snort](https://snort.org) ([github](https://github.com/snort3/snort3) ⭐ 3,421 | 🐛 80 | 🌐 C++ | 📅 2026-04-23) - A network intrusion detection tool
* [Netcap](https://github.com/dreadl0ck/netcap) ⭐ 1,803 | 🐛 11 | 🌐 Go | 📅 2026-09-11 - A framework for secure and scalable network traffic analysis
...
* [Sublime Platform](https://github.com/sublime-security/sublime-platform) ⭐ 269 | 🐛 17 | 🌐 Shell | 📅 2026-09-11 - An email threat detection engine

## Detection Rules

* [Sigma](https://github.com/SigmaHQ/sigma) ⭐ 11,028 | 🐛 203 | 🌐 Python | 📅 2026-09-07 - Generic Signature Format for SIEM Systems
* [ThreatHunter-Playbook](https://github.com/OTRF/ThreatHunter-Playbook) ⭐ 4,658 | 🐛 6 | 🌐 Python | 📅 2026-01-12 - A community-driven, open-source project to share detection logic, adversary tradecraft and resources to make detection development more efficient.
* [Awesome YARA Rules](https://github.com/InQuest/awesome-yara#rules) ⭐ 4,271 | 🐛 2 | 📅 2026-06-15
* [Elastic Detection Rules](https://github.com/elastic/detection-rules) ⭐ 2,701 | 🐛 224 | 🌐 Python | 📅 2026-09-12
* [Chronicle Detection Rules](https://github.com/chronicle/detection-rules) ⭐ 515 | 🐛 13 | 🌐 Python | 📅 2026-08-06 - Collection of YARA-L 2.0 sample rules for the Chronicle Detection API.
* [Sublime Detection Rules](https://github.com/sublime-security/sublime-rules) ⭐ 373 | 🐛 69 | 🌐 YAML | 📅 2026-09-12 - Email attack detection, response, and hunting rules.
...
* [theZoo](https://github.com/ytisf/theZoo) ⭐ 13,381 | 🐛 89 | 🌐 Python | 📅 2026-07-24 - A repository of LIVE malwares
...
* [ThreatHunter-Playbook](https://github.com/Cyb3rWard0g/ThreatHunter-Playbook) ⭐ 4,658 | 🐛 6 | 🌐 Python | 📅 2026-01-12 - A Threat hunter's playbook to aid the development of techniques and hypothesis for hunting campaigns.
...
* [The ThreatHunting Project](https://github.com/ThreatHuntingProject/ThreatHunting) ⭐ 1,890 | 🐛 7 | 📅 2021-11-17 - A great [collection of hunts](https://github.com/ThreatHuntingProject/ThreatHunting/tree/master/hunts) ⭐ 1,890 | 🐛 7 | 📅 2021-11-17 and threat hunting resources.
...
* [Open Cybersecurity Schema Framework (OCSF)](https://github.com/ocsf/ocsf-schema) ⭐ 889 | 🐛 171 | 📅 2026-09-11 -  A framework for creating schemas and it also delivers a cybersecurity event schema built with the framework ([schema browser](https://schema.ocsf.io/)).
...
* [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,850 | 🐛 327 | 📅 2026-01-11
* [Awesome Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,186 | 🐛 25 | 📅 2024-06-07
* [Awesome Honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,553 | 🐛 25 | 🌐 Python | 📅 2026-06-01
* [Awesome Incident Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,379 | 🐛 81 | 📅 2026-07-15
...
* [Awesome Cloud Security](https://github.com/4ndersonLin/awesome-cloud-security) ⭐ 2,485 | 🐛 23 | 📅 2026-03-17
...
* [Atomic Red Team](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,522 | 🐛 33 | 🌐 C | 📅 2026-09-05 - Small and highly portable detection tests mapped to the Mitre ATT\&CK Framework.
...
* [MITRE CALDERA](https://github.com/mitre/caldera) ⭐ 7,255 | 🐛 71 | 🌐 Python | 📅 2026-08-27 - An automated adversary emulation system that performs post-compromise adversarial behavior within Windows Enterprise networks.
...
* [Red Teaming/Adversary Simulation Toolkit](https://github.com/infosecn1nja/Red-Teaming-Toolkit) ⭐ 10,702 | 🐛 8 | 📅 2026-05-07 - A collection of open source and commercial tools that aid in red team operations.
