...
* [YARA](https://github.com/virustotal/yara) ⭐ 9,861 | 🐛 170 | 🌐 C | 📅 2026-08-25 - The pattern matching swiss knife
* [Dispatch](https://github.com/Netflix/dispatch) ⚠️ Archived - An open-source crisis management orchestration framework
* [Capa](https://github.com/fireeye/capa) ⭐ 6,177 | 🐛 299 | 🌐 Python | 📅 2026-09-08 - An open-source tool to identify capabilities in executable files.
* [DetectionLab](https://github.com/clong/DetectionLab/) ⭐ 5,018 | 🐛 42 | 🌐 HTML | 📅 2024-07-06 - Vagrant & Packer scripts to build a lab environment complete with security tooling and logging best practices.
* [ProcMon for Linux](https://github.com/Sysinternals/ProcMon-for-Linux) ⭐ 4,735 | 🐛 33 | 🌐 C | 📅 2026-09-09
* [Intel Owl](https://github.com/intelowlproject/IntelOwl) ⭐ 4,706 | 🐛 73 | 🌐 Python | 📅 2026-09-08 - An Open Source Intelligence, or OSINT solution to get threat intelligence data about a specific file, an IP or a domain from a single API at scale.
...
* [MITRE ATT\&CK Navigator](https://mitre.github.io/attack-navigator/enterprise/) ([source code](https://github.com/mitre-attack/attack-navigator) ⭐ 2,456 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-09) - The ATT\&CK Navigator is designed to provide basic navigation and annotation of ATT\&CK matrices, something that people are already doing today in tools like Excel.
...
* [Splunk Security Content](https://github.com/splunk/security_content) ⭐ 1,687 | 🐛 13 | 🌐 Python | 📅 2026-09-10 Splunk-curated detection content that can easily be used accross many SIEMs (see Uncoder Rule Converter.)
...
* [VAST](https://github.com/tenzir/vast) ⭐ 758 | 🐛 0 | 🌐 C++ | 📅 2026-09-09 - A network telemetry engine for data-driven security investigations.
...
* [Shuffle](https://github.com/Shuffle/Shuffle) ⭐ 2,431 | 🐛 491 | 🌐 JavaScript | 📅 2026-09-10: A general purpose security automation platform.
...
* [Sublime](https://github.com/sublime-security/sublime-platform) ⭐ 269 | 🐛 17 | 🌐 Shell | 📅 2026-09-08: An open platform for detection, response, and threat hunting in email environments. Sublime lets you write advanced detections as code to alert and remediate threats like phishing in real-time.

### Endpoint Monitoring

* [osquery](https://osquery.io) ([github](https://github.com/osquery/osquery) ⭐ 23,558 | 🐛 642 | 🌐 C++ | 📅 2026-09-09) - SQL powered operating system instrumentation, monitoring, and analytics
* [WAZUH](https://github.com/wazuh/wazuh) ⭐ 16,823 | 🐛 3,057 | 🌐 C++ | 📅 2026-09-10 - An open-source security platform
...
* [OSSEC](https://github.com/ossec/ossec-hids) ⭐ 5,056 | 🐛 124 | 🌐 C | 📅 2026-08-26 - An open-source Host-based Intrusion Detection System (HIDS)
* [Velociraptor](https://github.com/Velocidex/velociraptor) ⭐ 4,239 | 🐛 79 | 🌐 Go | 📅 2026-09-10 - Endpoint visibility and collection tool
* [Sysmon for Linux](https://github.com/Sysinternals/SysmonForLinux) ⭐ 2,158 | 🐛 41 | 🌐 C | 📅 2026-09-09
...
* [sysmon-config](https://github.com/SwiftOnSecurity/sysmon-config) ⭐ 5,642 | 🐛 82 | 📅 2024-07-03 - Sysmon configuration file template with default high-quality event tracing.
* [sysmon-modular](https://github.com/olafhartong/sysmon-modular) ⭐ 3,129 | 🐛 49 | 🌐 PowerShell | 📅 2026-09-09 - A repository of sysmon configuration modules. It also includes a [mapping](https://github.com/olafhartong/sysmon-modular/blob/master/attack_matrix/README.md) ⭐ 3,129 | 🐛 49 | 🌐 PowerShell | 📅 2026-09-09 of Sysmon configurations to MITRE ATT\&CK techniques.
* [auditd configuration](https://github.com/Neo23x0/auditd) ⭐ 1,909 | 🐛 18 | 🌐 Shell | 📅 2026-05-04
...
* [osquery-configuration](https://github.com/palantir/osquery-configuration) ⭐ 902 | 🐛 7 | 📅 2025-09-08 - A repository for using osquery for incident detection and response.

### Network Monitoring

* [ntopng](https://github.com/ntop/ntopng) ⭐ 8,149 | 🐛 302 | 🌐 Lua | 📅 2026-09-10 - A web-based network traffic monitoring tool
* [Zeek](https://github.com/zeek/zeek) ⭐ 7,952 | 🐛 254 | 🌐 C++ | 📅 2026-09-10 (formerly Bro) - A network security monitoring tool
* [Arkime](https://github.com/arkime/arkime) ⭐ 7,461 | 🐛 39 | 🌐 C | 📅 2026-09-10) - A large scale and open source full packet capture and search tool
* [Snort](https://snort.org) ([github](https://github.com/snort3/snort3) ⭐ 3,420 | 🐛 80 | 🌐 C++ | 📅 2026-04-23) - A network intrusion detection tool
* [Netcap](https://github.com/dreadl0ck/netcap) ⭐ 1,803 | 🐛 11 | 🌐 Go | 📅 2026-09-07 - A framework for secure and scalable network traffic analysis
...
* [JARM](https://github.com/salesforce/jarm) ⭐ 1,321 | 🐛 15 | 🌐 Python | 📅 2026-08-13 - An active Transport Layer Security (TLS) server fingerprinting tool.
...
* [Sublime Platform](https://github.com/sublime-security/sublime-platform) ⭐ 269 | 🐛 17 | 🌐 Shell | 📅 2026-09-08 - An email threat detection engine

## Detection Rules

* [Sigma](https://github.com/SigmaHQ/sigma) ⭐ 11,017 | 🐛 201 | 🌐 Python | 📅 2026-09-07 - Generic Signature Format for SIEM Systems
* [ThreatHunter-Playbook](https://github.com/OTRF/ThreatHunter-Playbook) ⭐ 4,656 | 🐛 6 | 🌐 Python | 📅 2026-01-12 - A community-driven, open-source project to share detection logic, adversary tradecraft and resources to make detection development more efficient.
* [Awesome YARA Rules](https://github.com/InQuest/awesome-yara#rules) ⭐ 4,271 | 🐛 2 | 📅 2026-06-15
* [Elastic Detection Rules](https://github.com/elastic/detection-rules) ⭐ 2,701 | 🐛 239 | 🌐 Python | 📅 2026-09-10
...
* [Sublime Detection Rules](https://github.com/sublime-security/sublime-rules) ⭐ 373 | 🐛 69 | 🌐 YAML | 📅 2026-09-10 - Email attack detection, response, and hunting rules.
...
* [theZoo](https://github.com/ytisf/theZoo) ⭐ 13,372 | 🐛 89 | 🌐 Python | 📅 2026-07-24 - A repository of LIVE malwares
...
* [attack\_data](https://github.com/splunk/attack_data) ⭐ 811 | 🐛 3 | 🌐 Python | 📅 2026-09-07 - A repository of curated datasets from various attacks.
* [Boss of the SOC (BOTS) Dataset Version 3](https://github.com/splunk/botsv3) ⭐ 490 | 🐛 0 | 📅 2020-06-18
...
* [ThreatHunter-Playbook](https://github.com/Cyb3rWard0g/ThreatHunter-Playbook) ⭐ 4,656 | 🐛 6 | 🌐 Python | 📅 2026-01-12 - A Threat hunter's playbook to aid the development of techniques and hypothesis for hunting campaigns.
* [Awesome YARA](https://github.com/InQuest/awesome-yara) ⭐ 4,271 | 🐛 2 | 📅 2026-06-15 - A curated list of awesome YARA rules, tools, and resources
* [The ThreatHunting Project](https://github.com/ThreatHuntingProject/ThreatHunting) ⭐ 1,889 | 🐛 7 | 📅 2021-11-17 - A great [collection of hunts](https://github.com/ThreatHuntingProject/ThreatHunting/tree/master/hunts) ⭐ 1,889 | 🐛 7 | 📅 2021-11-17 and threat hunting resources.
...
* [Open Cybersecurity Schema Framework (OCSF)](https://github.com/ocsf/ocsf-schema) ⭐ 889 | 🐛 171 | 📅 2026-09-04 -  A framework for creating schemas and it also delivers a cybersecurity event schema built with the framework ([schema browser](https://schema.ocsf.io/)).
...
* [The osquery Extensions Skunkworks Project](https://github.com/trailofbits/presentations/tree/master/Osquery%20Extensions) ⭐ 1,889 | 🐛 3 | 🌐 Python | 📅 2026-09-09
...
* [msticpy](https://github.com/microsoft/msticpy) ⭐ 1,999 | 🐛 13 | 🌐 Python | 📅 2026-08-13 - A library for InfoSec investigation and hunting in Jupyter Notebooks.
...
* [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,842 | 🐛 324 | 📅 2026-01-11
* [Awesome Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,185 | 🐛 25 | 📅 2024-06-07
* [Awesome Honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,550 | 🐛 23 | 🌐 Python | 📅 2026-06-01
* [Awesome Incident Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,378 | 🐛 80 | 📅 2026-07-15
* [Awesome Forensics](https://github.com/cugu/awesome-forensics) ⭐ 5,179 | 🐛 11 | 📅 2026-09-05
* [Awesome YARA](https://github.com/InQuest/awesome-yara) ⭐ 4,271 | 🐛 2 | 📅 2026-06-15
* [Awesome Cloud Security](https://github.com/4ndersonLin/awesome-cloud-security) ⭐ 2,487 | 🐛 23 | 📅 2026-03-17
...
* [DetectionLab](https://github.com/clong/DetectionLab/) ⭐ 5,018 | 🐛 42 | 🌐 HTML | 📅 2024-07-06 - Vagrant & Packer scripts to build a lab environment complete with security tooling and logging best practices.
* [HELK](https://github.com/Cyb3rWard0g/HELK) ⭐ 3,930 | 🐛 60 | 🌐 Jupyter Notebook | 📅 2024-06-01 - A Hunting ELK (Elasticsearch, Logstash, Kibana) with advanced analytic capabilities.
* [attack\_range](https://github.com/splunk/attack_range) ⭐ 2,553 | 🐛 21 | 🌐 Python | 📅 2026-09-09 - A tool that allows you to create vulnerable instrumented local or cloud environments to simulate attacks against and collect the data into Splunk.
* [BlueTeam Lab](https://github.com/op7ic/BlueTeam.Lab) ⭐ 189 | 🐛 1 | 🌐 Jinja | 📅 2024-11-20 - A detection lab created with Terraform and Ansible in Azure.
...
* [Atomic Red Team](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,514 | 🐛 33 | 🌐 C | 📅 2026-09-05 - Small and highly portable detection tests mapped to the Mitre ATT\&CK Framework.
...
* [MITRE CALDERA](https://github.com/mitre/caldera) ⭐ 7,251 | 🐛 71 | 🌐 Python | 📅 2026-08-27 - An automated adversary emulation system that performs post-compromise adversarial behavior within Windows Enterprise networks.
* [Infection Monkey](https://github.com/guardicore/monkey) ⭐ 7,088 | 🐛 240 | 🌐 Python | 📅 2025-05-01 - An open source Breach and Attack Simulation (BAS) tool that assesses the resiliency of private and public cloud environments to post-breach attacks and lateral movement.
* [APTSimulator](https://github.com/NextronSystems/APTSimulator) ⭐ 2,768 | 🐛 4 | 🌐 Batchfile | 📅 2025-09-23 - A Windows Batch script that uses a set of tools and output files to make a system look as if it was compromised.
* [Splunk Attack Range](https://github.com/splunk/attack_range) ⭐ 2,553 | 🐛 21 | 🌐 Python | 📅 2026-09-09 - A tool that allows you to create vulnerable instrumented local or cloud environments to simulate attacks against and collect the data into Splunk.
...
* [Red Teaming/Adversary Simulation Toolkit](https://github.com/infosecn1nja/Red-Teaming-Toolkit) ⭐ 10,698 | 🐛 8 | 📅 2026-05-07 - A collection of open source and commercial tools that aid in red team operations.
* [Awesome Red Teaming](https://github.com/yeyintminthuhtut/Awesome-Red-Teaming) ⭐ 8,088 | 🐛 19 | 📅 2023-12-28 - A list of awesome red teaming resources
...
* [adversary\_emulation\_library](https://github.com/center-for-threat-informed-defense/adversary_emulation_library) ⭐ 2,160 | 🐛 40 | 🌐 C | 📅 2025-05-28 - An open library of adversary emulation plans designed to empower organizations to test their defenses based on real-world TTPs.
