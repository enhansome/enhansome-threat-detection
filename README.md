...
* [YARA](https://github.com/virustotal/yara) ⭐ 9,816 | 🐛 171 | 🌐 C | 📅 2026-08-21 - The pattern matching swiss knife
* [Dispatch](https://github.com/Netflix/dispatch) ⚠️ Archived - An open-source crisis management orchestration framework
* [Capa](https://github.com/fireeye/capa) ⭐ 6,152 | 🐛 291 | 🌐 Python | 📅 2026-08-18 - An open-source tool to identify capabilities in executable files.
* [DetectionLab](https://github.com/clong/DetectionLab/) ⭐ 5,009 | 🐛 42 | 🌐 HTML | 📅 2024-07-06 - Vagrant & Packer scripts to build a lab environment complete with security tooling and logging best practices.
* [ProcMon for Linux](https://github.com/Sysinternals/ProcMon-for-Linux) ⭐ 4,726 | 🐛 31 | 🌐 C | 📅 2026-05-07
* [Intel Owl](https://github.com/intelowlproject/IntelOwl) ⭐ 4,680 | 🐛 70 | 🌐 Python | 📅 2026-08-20 - An Open Source Intelligence, or OSINT solution to get threat intelligence data about a specific file, an IP or a domain from a single API at scale.
...
* [MITRE ATT\&CK Navigator](https://mitre.github.io/attack-navigator/enterprise/) ([source code](https://github.com/mitre-attack/attack-navigator) ⭐ 2,445 | 🐛 74 | 🌐 TypeScript | 📅 2026-08-20) - The ATT\&CK Navigator is designed to provide basic navigation and annotation of ATT\&CK matrices, something that people are already doing today in tools like Excel.
...
* [hollows\_hunter](https://github.com/hasherezade/hollows_hunter) ⭐ 2,398 | 🐛 2 | 🌐 C | 📅 2026-06-06 - Scans all running processes, recognizes and dumps a variety of potentially malicious implants (replaced/implanted PEs, shellcodes, hooks, in-memory patches).
...
* [Splunk Security Content](https://github.com/splunk/security_content) ⭐ 1,676 | 🐛 15 | 🌐 Python | 📅 2026-08-21 Splunk-curated detection content that can easily be used accross many SIEMs (see Uncoder Rule Converter.)
...
* [VAST](https://github.com/tenzir/vast) ⭐ 756 | 🐛 0 | 🌐 C++ | 📅 2026-08-22 - A network telemetry engine for data-driven security investigations.
...
* [ElastAlert](https://github.com/Yelp/elastalert) ⭐ 7,986 | 🐛 1,401 | 🌐 Python | 📅 2024-08-07 - A framework for alerting on anomalies, spikes, or other patterns of interest from data in Elasticsearch
...
* [Shuffle](https://github.com/Shuffle/Shuffle) ⭐ 2,417 | 🐛 490 | 🌐 JavaScript | 📅 2026-08-19: A general purpose security automation platform.
...
* [WAZUH](https://github.com/wazuh/wazuh) ⭐ 16,632 | 🐛 2,975 | 🌐 C++ | 📅 2026-08-21 - An open-source security platform
...
* [Velociraptor](https://github.com/Velocidex/velociraptor) ⭐ 4,194 | 🐛 72 | 🌐 Go | 📅 2026-08-20 - Endpoint visibility and collection tool
* [Sysmon for Linux](https://github.com/Sysinternals/SysmonForLinux) ⭐ 2,152 | 🐛 42 | 🌐 C | 📅 2026-07-13
...
* [auditd configuration](https://github.com/Neo23x0/auditd) ⭐ 1,891 | 🐛 18 | 🌐 Shell | 📅 2026-05-04
...
* [ntopng](https://github.com/ntop/ntopng) ⭐ 8,099 | 🐛 336 | 🌐 Lua | 📅 2026-08-21 - A web-based network traffic monitoring tool
* [Zeek](https://github.com/zeek/zeek) ⭐ 7,896 | 🐛 245 | 🌐 C++ | 📅 2026-08-21 (formerly Bro) - A network security monitoring tool
* [Arkime](https://github.com/arkime/arkime) ⭐ 7,448 | 🐛 35 | 🌐 C | 📅 2026-08-21) - A large scale and open source full packet capture and search tool
...
* [Sigma](https://github.com/SigmaHQ/sigma) ⭐ 10,927 | 🐛 196 | 🌐 Python | 📅 2026-08-18 - Generic Signature Format for SIEM Systems
...
* [Awesome YARA Rules](https://github.com/InQuest/awesome-yara#rules) ⭐ 4,259 | 🐛 1 | 📅 2026-06-15
* [Elastic Detection Rules](https://github.com/elastic/detection-rules) ⭐ 2,691 | 🐛 256 | 🌐 Python | 📅 2026-08-21
...
* [Sublime Detection Rules](https://github.com/sublime-security/sublime-rules) ⭐ 372 | 🐛 105 | 🌐 YAML | 📅 2026-08-22 - Email attack detection, response, and hunting rules.
...
* [theZoo](https://github.com/ytisf/theZoo) ⭐ 13,314 | 🐛 89 | 🌐 Python | 📅 2026-07-24 - A repository of LIVE malwares
...
* [attack\_data](https://github.com/splunk/attack_data) ⭐ 807 | 🐛 4 | 🌐 Python | 📅 2026-08-19 - A repository of curated datasets from various attacks.
...
* [Awesome YARA](https://github.com/InQuest/awesome-yara) ⭐ 4,259 | 🐛 1 | 📅 2026-06-15 - A curated list of awesome YARA rules, tools, and resources
...
* [msticpy](https://github.com/microsoft/msticpy) ⭐ 1,994 | 🐛 12 | 🌐 Python | 📅 2026-08-13 - A library for InfoSec investigation and hunting in Jupyter Notebooks.
...
* [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,783 | 🐛 313 | 📅 2026-01-11
* [Awesome Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,146 | 🐛 25 | 📅 2024-06-07
* [Awesome Honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,525 | 🐛 22 | 🌐 Python | 📅 2026-06-01
* [Awesome Incident Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,346 | 🐛 74 | 📅 2026-07-15
* [Awesome Forensics](https://github.com/cugu/awesome-forensics) ⭐ 5,161 | 🐛 7 | 📅 2026-05-14
* [Awesome YARA](https://github.com/InQuest/awesome-yara) ⭐ 4,259 | 🐛 1 | 📅 2026-06-15
...
* [DetectionLab](https://github.com/clong/DetectionLab/) ⭐ 5,009 | 🐛 42 | 🌐 HTML | 📅 2024-07-06 - Vagrant & Packer scripts to build a lab environment complete with security tooling and logging best practices.
* [HELK](https://github.com/Cyb3rWard0g/HELK) ⭐ 3,930 | 🐛 60 | 🌐 Jupyter Notebook | 📅 2024-06-01 - A Hunting ELK (Elasticsearch, Logstash, Kibana) with advanced analytic capabilities.
* [attack\_range](https://github.com/splunk/attack_range) ⭐ 2,543 | 🐛 22 | 🌐 Python | 📅 2026-08-11 - A tool that allows you to create vulnerable instrumented local or cloud environments to simulate attacks against and collect the data into Splunk.
...
* [Atomic Red Team](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,435 | 🐛 28 | 🌐 C | 📅 2026-08-17 - Small and highly portable detection tests mapped to the Mitre ATT\&CK Framework.
...
* [MITRE CALDERA](https://github.com/mitre/caldera) ⭐ 7,210 | 🐛 76 | 🌐 Python | 📅 2026-08-12 - An automated adversary emulation system that performs post-compromise adversarial behavior within Windows Enterprise networks.
...
* [Splunk Attack Range](https://github.com/splunk/attack_range) ⭐ 2,543 | 🐛 22 | 🌐 Python | 📅 2026-08-11 - A tool that allows you to create vulnerable instrumented local or cloud environments to simulate attacks against and collect the data into Splunk.
...
* [Red Teaming/Adversary Simulation Toolkit](https://github.com/infosecn1nja/Red-Teaming-Toolkit) ⭐ 10,641 | 🐛 9 | 📅 2026-05-07 - A collection of open source and commercial tools that aid in red team operations.
* [Awesome Red Teaming](https://github.com/yeyintminthuhtut/Awesome-Red-Teaming) ⭐ 8,065 | 🐛 19 | 📅 2023-12-28 - A list of awesome red teaming resources
* [Red-Team Infrastructure Wiki](https://github.com/bluscreenofjeff/Red-Team-Infrastructure-Wiki) ⭐ 4,517 | 🐛 0 | 📅 2025-10-01 - Wiki to collect Red Team infrastructure hardening resources.
* [adversary\_emulation\_library](https://github.com/center-for-threat-informed-defense/adversary_emulation_library) ⭐ 2,153 | 🐛 40 | 🌐 C | 📅 2025-05-28 - An open library of adversary emulation plans designed to empower organizations to test their defenses based on real-world TTPs.
