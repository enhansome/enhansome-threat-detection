...
* [YARA](https://github.com/virustotal/yara) ⭐ 9,808 | 🐛 177 | 🌐 C | 📅 2026-07-30 - The pattern matching swiss knife
* [Dispatch](https://github.com/Netflix/dispatch) ⚠️ Archived - An open-source crisis management orchestration framework
* [Capa](https://github.com/fireeye/capa) ⭐ 6,137 | 🐛 287 | 🌐 Python | 📅 2026-08-14 - An open-source tool to identify capabilities in executable files.
* [DetectionLab](https://github.com/clong/DetectionLab/) ⭐ 5,010 | 🐛 42 | 🌐 HTML | 📅 2024-07-06 - Vagrant & Packer scripts to build a lab environment complete with security tooling and logging best practices.
* [ProcMon for Linux](https://github.com/Sysinternals/ProcMon-for-Linux) ⭐ 4,718 | 🐛 31 | 🌐 C | 📅 2026-05-07
* [Intel Owl](https://github.com/intelowlproject/IntelOwl) ⭐ 4,667 | 🐛 63 | 🌐 Python | 📅 2026-08-14 - An Open Source Intelligence, or OSINT solution to get threat intelligence data about a specific file, an IP or a domain from a single API at scale.
...
* [MITRE ATT\&CK Navigator](https://mitre.github.io/attack-navigator/enterprise/) ([source code](https://github.com/mitre-attack/attack-navigator) ⭐ 2,439 | 🐛 73 | 🌐 TypeScript | 📅 2026-08-11) - The ATT\&CK Navigator is designed to provide basic navigation and annotation of ATT\&CK matrices, something that people are already doing today in tools like Excel.
...
* [hollows\_hunter](https://github.com/hasherezade/hollows_hunter) ⭐ 2,396 | 🐛 2 | 🌐 C | 📅 2026-06-06 - Scans all running processes, recognizes and dumps a variety of potentially malicious implants (replaced/implanted PEs, shellcodes, hooks, in-memory patches).
...
* [Splunk Security Content](https://github.com/splunk/security_content) ⭐ 1,672 | 🐛 16 | 🌐 Python | 📅 2026-08-14 Splunk-curated detection content that can easily be used accross many SIEMs (see Uncoder Rule Converter.)
...
* [VAST](https://github.com/tenzir/vast) ⭐ 754 | 🐛 0 | 🌐 C++ | 📅 2026-08-14 - A network telemetry engine for data-driven security investigations.
* [Revoke-Obfuscation](https://github.com/danielbohannon/Revoke-Obfuscation) ⭐ 752 | 🐛 16 | 🌐 PowerShell | 📅 2023-12-01 - PowerShell Obfuscation Detection Framework.
...
* [Shuffle](https://github.com/Shuffle/Shuffle) ⭐ 2,411 | 🐛 490 | 🌐 JavaScript | 📅 2026-08-14: A general purpose security automation platform.
* [Matano](https://github.com/matanolabs/matano) ⭐ 1,693 | 🐛 55 | 🌐 Rust | 📅 2025-01-08: An open source security lake platform (SIEM alternative) for threat hunting, detection and response on AWS. Matano lets you write advanced detections as code (using python) to correlate and alert on threats in realtime.
...
* [osquery](https://osquery.io) ([github](https://github.com/osquery/osquery) ⭐ 23,462 | 🐛 618 | 🌐 C++ | 📅 2026-08-13) - SQL powered operating system instrumentation, monitoring, and analytics
* [WAZUH](https://github.com/wazuh/wazuh) ⭐ 16,528 | 🐛 2,976 | 🌐 C++ | 📅 2026-08-15 - An open-source security platform
* [Sysdig](https://github.com/draios/sysdig) ⭐ 8,283 | 🐛 116 | 🌐 C++ | 📅 2026-04-13 - A tool for deep Linux system visibility, with native support for containers. Think about sysdig as strace + tcpdump + htop + iftop + lsof + ...awesome sauce
* [OSSEC](https://github.com/ossec/ossec-hids) ⭐ 5,047 | 🐛 151 | 🌐 C | 📅 2026-08-12 - An open-source Host-based Intrusion Detection System (HIDS)
* [Velociraptor](https://github.com/Velocidex/velociraptor) ⭐ 4,178 | 🐛 67 | 🌐 Go | 📅 2026-08-12 - Endpoint visibility and collection tool
* [Sysmon for Linux](https://github.com/Sysinternals/SysmonForLinux) ⭐ 2,149 | 🐛 40 | 🌐 C | 📅 2026-07-13
* [go-audit](https://github.com/slackhq/go-audit) ⭐ 1,664 | 🐛 23 | 🌐 Go | 📅 2026-07-27 - An alternative to the Linux auditd daemon
...
* [sysmon-config](https://github.com/SwiftOnSecurity/sysmon-config) ⭐ 5,621 | 🐛 82 | 📅 2024-07-03 - Sysmon configuration file template with default high-quality event tracing.
* [sysmon-modular](https://github.com/olafhartong/sysmon-modular) ⭐ 3,114 | 🐛 49 | 🌐 PowerShell | 📅 2026-08-10 - A repository of sysmon configuration modules. It also includes a [mapping](https://github.com/olafhartong/sysmon-modular/blob/master/attack_matrix/README.md) ⭐ 3,114 | 🐛 49 | 🌐 PowerShell | 📅 2026-08-10 of Sysmon configurations to MITRE ATT\&CK techniques.
* [auditd configuration](https://github.com/Neo23x0/auditd) ⭐ 1,888 | 🐛 18 | 🌐 Shell | 📅 2026-05-04
* [sysmon-DFIR](https://github.com/MHaggis/sysmon-dfir) ⭐ 942 | 🐛 0 | 📅 2023-12-12 - Sources, configuration and how to detect evil things utilizing Microsoft Sysmon.
...
* [ntopng](https://github.com/ntop/ntopng) ⭐ 8,089 | 🐛 330 | 🌐 Lua | 📅 2026-08-14 - A web-based network traffic monitoring tool
* [Zeek](https://github.com/zeek/zeek) ⭐ 7,875 | 🐛 247 | 🌐 C++ | 📅 2026-08-14 (formerly Bro) - A network security monitoring tool
* [Arkime](https://github.com/arkime/arkime) ⭐ 7,446 | 🐛 35 | 🌐 C | 📅 2026-08-14) - A large scale and open source full packet capture and search tool
...
* [Recog](https://github.com/rapid7/recog) ⭐ 789 | 🐛 28 | 🌐 Ruby | 📅 2026-08-10 - A framework for identifying products, services, operating systems, and hardware by matching fingerprints against data returned from various network probes
...
* [Sigma](https://github.com/SigmaHQ/sigma) ⭐ 10,887 | 🐛 195 | 🌐 Python | 📅 2026-08-15 - Generic Signature Format for SIEM Systems
* [ThreatHunter-Playbook](https://github.com/OTRF/ThreatHunter-Playbook) ⭐ 4,635 | 🐛 6 | 🌐 Python | 📅 2026-01-12 - A community-driven, open-source project to share detection logic, adversary tradecraft and resources to make detection development more efficient.
* [Awesome YARA Rules](https://github.com/InQuest/awesome-yara#rules) ⭐ 4,255 | 🐛 1 | 📅 2026-06-15
* [Elastic Detection Rules](https://github.com/elastic/detection-rules) ⭐ 2,686 | 🐛 245 | 🌐 Python | 📅 2026-08-15
* [Chronicle Detection Rules](https://github.com/chronicle/detection-rules) ⭐ 513 | 🐛 12 | 🌐 Python | 📅 2026-08-06 - Collection of YARA-L 2.0 sample rules for the Chronicle Detection API.
* [Sublime Detection Rules](https://github.com/sublime-security/sublime-rules) ⭐ 371 | 🐛 133 | 🌐 YAML | 📅 2026-08-15 - Email attack detection, response, and hunting rules.
...
* [theZoo](https://github.com/ytisf/theZoo) ⭐ 13,297 | 🐛 89 | 🌐 Python | 📅 2026-07-24 - A repository of LIVE malwares
* [EVTX-ATTACK-SAMPLES](https://github.com/sbousseaden/EVTX-ATTACK-SAMPLES) ⭐ 2,606 | 🐛 5 | 🌐 HTML | 📅 2023-01-24 - A repo of Windows event samples (EVTX) associated with ATT\&CK techniques ([EVTX-ATT\&CK Sheet](https://docs.google.com/spreadsheets/d/12V5T9j6Fi3JSmMpAsMwovnWqRFKzzI9l2iXS5dEsnrs/edit#gid=164587082)).
...
* [attack\_data](https://github.com/splunk/attack_data) ⭐ 802 | 🐛 3 | 🌐 Python | 📅 2026-08-10 - A repository of curated datasets from various attacks.
* [Boss of the SOC (BOTS) Dataset Version 3](https://github.com/splunk/botsv3) ⭐ 477 | 🐛 0 | 📅 2020-06-18
* [Boss of the SOC (BOTS) Dataset Version 1](https://github.com/splunk/botsv1) ⭐ 476 | 🐛 1 | 📅 2024-08-08
...
* [ThreatHunter-Playbook](https://github.com/Cyb3rWard0g/ThreatHunter-Playbook) ⭐ 4,635 | 🐛 6 | 🌐 Python | 📅 2026-01-12 - A Threat hunter's playbook to aid the development of techniques and hypothesis for hunting campaigns.
* [Awesome YARA](https://github.com/InQuest/awesome-yara) ⭐ 4,255 | 🐛 1 | 📅 2026-06-15 - A curated list of awesome YARA rules, tools, and resources
* [The ThreatHunting Project](https://github.com/ThreatHuntingProject/ThreatHunting) ⭐ 1,885 | 🐛 7 | 📅 2021-11-17 - A great [collection of hunts](https://github.com/ThreatHuntingProject/ThreatHunting/tree/master/hunts) ⭐ 1,885 | 🐛 7 | 📅 2021-11-17 and threat hunting resources.
...
* [Alerting and Detection Strategies Framework](https://github.com/palantir/alerting-detection-strategy-framework) ⭐ 896 | 🐛 3 | 📅 2025-09-08 - A framework for developing alerting and detection strategies.
* [Open Cybersecurity Schema Framework (OCSF)](https://github.com/ocsf/ocsf-schema) ⭐ 876 | 🐛 154 | 📅 2026-08-03 -  A framework for creating schemas and it also delivers a cybersecurity event schema built with the framework ([schema browser](https://schema.ocsf.io/)).
...
* [The osquery Extensions Skunkworks Project](https://github.com/trailofbits/presentations/tree/master/Osquery%20Extensions) ⭐ 1,877 | 🐛 3 | 🌐 Python | 📅 2026-08-14
...
* [msticpy](https://github.com/microsoft/msticpy) ⭐ 1,991 | 🐛 11 | 🌐 Python | 📅 2026-08-13 - A library for InfoSec investigation and hunting in Jupyter Notebooks.
...
* [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,748 | 🐛 305 | 📅 2026-01-11
* [Awesome Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,120 | 🐛 25 | 📅 2024-06-07
* [Awesome Honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,521 | 🐛 21 | 🌐 Python | 📅 2026-06-01
* [Awesome Incident Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,326 | 🐛 73 | 📅 2026-07-15
* [Awesome Forensics](https://github.com/cugu/awesome-forensics) ⭐ 5,159 | 🐛 5 | 📅 2026-05-14
* [Awesome YARA](https://github.com/InQuest/awesome-yara) ⭐ 4,255 | 🐛 1 | 📅 2026-06-15
* [Awesome Cloud Security](https://github.com/4ndersonLin/awesome-cloud-security) ⭐ 2,476 | 🐛 19 | 📅 2026-03-17
...
* [DetectionLab](https://github.com/clong/DetectionLab/) ⭐ 5,010 | 🐛 42 | 🌐 HTML | 📅 2024-07-06 - Vagrant & Packer scripts to build a lab environment complete with security tooling and logging best practices.
* [HELK](https://github.com/Cyb3rWard0g/HELK) ⭐ 3,929 | 🐛 60 | 🌐 Jupyter Notebook | 📅 2024-06-01 - A Hunting ELK (Elasticsearch, Logstash, Kibana) with advanced analytic capabilities.
* [attack\_range](https://github.com/splunk/attack_range) ⭐ 2,537 | 🐛 22 | 🌐 Python | 📅 2026-08-11 - A tool that allows you to create vulnerable instrumented local or cloud environments to simulate attacks against and collect the data into Splunk.
...
* [Atomic Red Team](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,410 | 🐛 30 | 🌐 C | 📅 2026-08-13 - Small and highly portable detection tests mapped to the Mitre ATT\&CK Framework.
...
* [MITRE CALDERA](https://github.com/mitre/caldera) ⭐ 7,190 | 🐛 74 | 🌐 Python | 📅 2026-08-12 - An automated adversary emulation system that performs post-compromise adversarial behavior within Windows Enterprise networks.
* [Infection Monkey](https://github.com/guardicore/monkey) ⭐ 7,071 | 🐛 239 | 🌐 Python | 📅 2025-05-01 - An open source Breach and Attack Simulation (BAS) tool that assesses the resiliency of private and public cloud environments to post-breach attacks and lateral movement.
* [APTSimulator](https://github.com/NextronSystems/APTSimulator) ⭐ 2,762 | 🐛 4 | 🌐 Batchfile | 📅 2025-09-23 - A Windows Batch script that uses a set of tools and output files to make a system look as if it was compromised.
* [Splunk Attack Range](https://github.com/splunk/attack_range) ⭐ 2,537 | 🐛 22 | 🌐 Python | 📅 2026-08-11 - A tool that allows you to create vulnerable instrumented local or cloud environments to simulate attacks against and collect the data into Splunk.
* [SharpShooter](https://github.com/mdsecactivebreach/SharpShooter) ⭐ 1,985 | 🐛 23 | 🌐 VBA | 📅 2024-08-21 - Payload Generation Framework.
...
* [DumpsterFire](https://github.com/TryCatchHCF/DumpsterFire) ⭐ 1,039 | 🐛 4 | 🌐 Python | 📅 2020-05-27 - A modular, menu-driven, cross-platform tool for building repeatable, time-delayed, distributed security events.
...
* [Red Teaming/Adversary Simulation Toolkit](https://github.com/infosecn1nja/Red-Teaming-Toolkit) ⭐ 10,627 | 🐛 10 | 📅 2026-05-07 - A collection of open source and commercial tools that aid in red team operations.
* [Awesome Red Teaming](https://github.com/yeyintminthuhtut/Awesome-Red-Teaming) ⭐ 8,056 | 🐛 19 | 📅 2023-12-28 - A list of awesome red teaming resources
* [Red-Team Infrastructure Wiki](https://github.com/bluscreenofjeff/Red-Team-Infrastructure-Wiki) ⭐ 4,513 | 🐛 0 | 📅 2025-10-01 - Wiki to collect Red Team infrastructure hardening resources.
* [adversary\_emulation\_library](https://github.com/center-for-threat-informed-defense/adversary_emulation_library) ⭐ 2,150 | 🐛 40 | 🌐 C | 📅 2025-05-28 - An open library of adversary emulation plans designed to empower organizations to test their defenses based on real-world TTPs.
