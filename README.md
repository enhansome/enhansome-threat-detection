...
* [YARA](https://github.com/virustotal/yara) ⭐ 9,817 | 🐛 171 | 🌐 C | 📅 2026-08-21 - The pattern matching swiss knife
* [Dispatch](https://github.com/Netflix/dispatch) ⚠️ Archived - An open-source crisis management orchestration framework
* [Capa](https://github.com/fireeye/capa) ⭐ 6,153 | 🐛 291 | 🌐 Python | 📅 2026-08-18 - An open-source tool to identify capabilities in executable files.
...
* [ProcMon for Linux](https://github.com/Sysinternals/ProcMon-for-Linux) ⭐ 4,726 | 🐛 32 | 🌐 C | 📅 2026-05-07
...
* [MITRE ATT\&CK Navigator](https://mitre.github.io/attack-navigator/enterprise/) ([source code](https://github.com/mitre-attack/attack-navigator) ⭐ 2,444 | 🐛 74 | 🌐 TypeScript | 📅 2026-08-20) - The ATT\&CK Navigator is designed to provide basic navigation and annotation of ATT\&CK matrices, something that people are already doing today in tools like Excel.
...
* [hollows\_hunter](https://github.com/hasherezade/hollows_hunter) ⭐ 2,400 | 🐛 2 | 🌐 C | 📅 2026-06-06 - Scans all running processes, recognizes and dumps a variety of potentially malicious implants (replaced/implanted PEs, shellcodes, hooks, in-memory patches).
...
* [Splunk Security Content](https://github.com/splunk/security_content) ⭐ 1,676 | 🐛 16 | 🌐 Python | 📅 2026-08-21 Splunk-curated detection content that can easily be used accross many SIEMs (see Uncoder Rule Converter.)
...
* [Shuffle](https://github.com/Shuffle/Shuffle) ⭐ 2,418 | 🐛 490 | 🌐 JavaScript | 📅 2026-08-19: A general purpose security automation platform.
...
* [osquery](https://osquery.io) ([github](https://github.com/osquery/osquery) ⭐ 23,482 | 🐛 623 | 🌐 C++ | 📅 2026-08-19) - SQL powered operating system instrumentation, monitoring, and analytics
* [WAZUH](https://github.com/wazuh/wazuh) ⭐ 16,642 | 🐛 2,977 | 🌐 C++ | 📅 2026-08-23 - An open-source security platform
...
* [Velociraptor](https://github.com/Velocidex/velociraptor) ⭐ 4,194 | 🐛 74 | 🌐 Go | 📅 2026-08-20 - Endpoint visibility and collection tool
* [Sysmon for Linux](https://github.com/Sysinternals/SysmonForLinux) ⭐ 2,151 | 🐛 42 | 🌐 C | 📅 2026-07-13
...
* [auditd configuration](https://github.com/Neo23x0/auditd) ⭐ 1,894 | 🐛 18 | 🌐 Shell | 📅 2026-05-04
...
* [ntopng](https://github.com/ntop/ntopng) ⭐ 8,101 | 🐛 335 | 🌐 Lua | 📅 2026-08-22 - A web-based network traffic monitoring tool
* [Zeek](https://github.com/zeek/zeek) ⭐ 7,898 | 🐛 245 | 🌐 C++ | 📅 2026-08-21 (formerly Bro) - A network security monitoring tool
* [Arkime](https://github.com/arkime/arkime) ⭐ 7,451 | 🐛 35 | 🌐 C | 📅 2026-08-21) - A large scale and open source full packet capture and search tool
* [Snort](https://snort.org) ([github](https://github.com/snort3/snort3) ⭐ 3,406 | 🐛 76 | 🌐 C++ | 📅 2026-04-23) - A network intrusion detection tool
* [Netcap](https://github.com/dreadl0ck/netcap) ⭐ 1,805 | 🐛 5 | 🌐 Go | 📅 2026-08-22 - A framework for secure and scalable network traffic analysis
...
* [JARM](https://github.com/salesforce/jarm) ⭐ 1,317 | 🐛 14 | 🌐 Python | 📅 2026-08-13 - An active Transport Layer Security (TLS) server fingerprinting tool.
...
* [Sigma](https://github.com/SigmaHQ/sigma) ⭐ 10,928 | 🐛 198 | 🌐 Python | 📅 2026-08-18 - Generic Signature Format for SIEM Systems
...
* [Elastic Detection Rules](https://github.com/elastic/detection-rules) ⭐ 2,692 | 🐛 256 | 🌐 Python | 📅 2026-08-21
...
* [Sublime Detection Rules](https://github.com/sublime-security/sublime-rules) ⭐ 372 | 🐛 105 | 🌐 YAML | 📅 2026-08-23 - Email attack detection, response, and hunting rules.
...
* [EVTX-ATTACK-SAMPLES](https://github.com/sbousseaden/EVTX-ATTACK-SAMPLES) ⭐ 2,612 | 🐛 5 | 🌐 HTML | 📅 2023-01-24 - A repo of Windows event samples (EVTX) associated with ATT\&CK techniques ([EVTX-ATT\&CK Sheet](https://docs.google.com/spreadsheets/d/12V5T9j6Fi3JSmMpAsMwovnWqRFKzzI9l2iXS5dEsnrs/edit#gid=164587082)).
...
* [Open Cybersecurity Schema Framework (OCSF)](https://github.com/ocsf/ocsf-schema) ⭐ 881 | 🐛 159 | 📅 2026-08-03 -  A framework for creating schemas and it also delivers a cybersecurity event schema built with the framework ([schema browser](https://schema.ocsf.io/)).
...
* [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,788 | 🐛 313 | 📅 2026-01-11
* [Awesome Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,149 | 🐛 25 | 📅 2024-06-07
* [Awesome Honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,528 | 🐛 22 | 🌐 Python | 📅 2026-06-01
...
* [Awesome Cloud Security](https://github.com/4ndersonLin/awesome-cloud-security) ⭐ 2,481 | 🐛 20 | 📅 2026-03-17
* [Awesome Kubernetes Threat Detection](https://github.com/jatrost/awesome-kubernetes-threat-detection) ⭐ 410 | 🐛 5 | 📅 2023-09-02
...
* [DetectionLab](https://github.com/clong/DetectionLab/) ⭐ 5,009 | 🐛 42 | 🌐 HTML | 📅 2024-07-06 - Vagrant & Packer scripts to build a lab environment complete with security tooling and logging best practices.
* [HELK](https://github.com/Cyb3rWard0g/HELK) ⭐ 3,930 | 🐛 60 | 🌐 Jupyter Notebook | 📅 2024-06-01 - A Hunting ELK (Elasticsearch, Logstash, Kibana) with advanced analytic capabilities.
* [attack\_range](https://github.com/splunk/attack_range) ⭐ 2,544 | 🐛 22 | 🌐 Python | 📅 2026-08-11 - A tool that allows you to create vulnerable instrumented local or cloud environments to simulate attacks against and collect the data into Splunk.
...
* [Atomic Red Team](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,441 | 🐛 29 | 🌐 C | 📅 2026-08-17 - Small and highly portable detection tests mapped to the Mitre ATT\&CK Framework.
...
* [Infection Monkey](https://github.com/guardicore/monkey) ⭐ 7,075 | 🐛 239 | 🌐 Python | 📅 2025-05-01 - An open source Breach and Attack Simulation (BAS) tool that assesses the resiliency of private and public cloud environments to post-breach attacks and lateral movement.
...
* [Splunk Attack Range](https://github.com/splunk/attack_range) ⭐ 2,544 | 🐛 22 | 🌐 Python | 📅 2026-08-11 - A tool that allows you to create vulnerable instrumented local or cloud environments to simulate attacks against and collect the data into Splunk.
...
* [Red Teaming/Adversary Simulation Toolkit](https://github.com/infosecn1nja/Red-Teaming-Toolkit) ⭐ 10,644 | 🐛 9 | 📅 2026-05-07 - A collection of open source and commercial tools that aid in red team operations.
* [Awesome Red Teaming](https://github.com/yeyintminthuhtut/Awesome-Red-Teaming) ⭐ 8,066 | 🐛 19 | 📅 2023-12-28 - A list of awesome red teaming resources
