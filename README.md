...
* [YARA](https://github.com/virustotal/yara) ⭐ 9,869 | 🐛 170 | 🌐 C | 📅 2026-08-25 - The pattern matching swiss knife
* [Dispatch](https://github.com/Netflix/dispatch) ⚠️ Archived - An open-source crisis management orchestration framework
* [Capa](https://github.com/fireeye/capa) ⭐ 6,184 | 🐛 307 | 🌐 Python | 📅 2026-09-14 - An open-source tool to identify capabilities in executable files.
...
* [Intel Owl](https://github.com/intelowlproject/IntelOwl) ⭐ 4,720 | 🐛 71 | 🌐 Python | 📅 2026-09-16 - An Open Source Intelligence, or OSINT solution to get threat intelligence data about a specific file, an IP or a domain from a single API at scale.
* [HELK](https://github.com/Cyb3rWard0g/HELK) ⭐ 3,928 | 🐛 60 | 🌐 Jupyter Notebook | 📅 2024-06-01 - A Hunting ELK (Elasticsearch, Logstash, Kibana) with advanced analytic capabilities.
...
* [MITRE ATT\&CK Navigator](https://mitre.github.io/attack-navigator/enterprise/) ([source code](https://github.com/mitre-attack/attack-navigator) ⭐ 2,462 | 🐛 79 | 🌐 TypeScript | 📅 2026-09-14) - The ATT\&CK Navigator is designed to provide basic navigation and annotation of ATT\&CK matrices, something that people are already doing today in tools like Excel.
* [DeepBlueCLI](https://github.com/sans-blue-team/DeepBlueCLI) ⭐ 2,431 | 🐛 13 | 🌐 PowerShell | 📅 2023-10-14 - A PowerShell Module for Hunt Teaming via Windows Event Logs
* [hollows\_hunter](https://github.com/hasherezade/hollows_hunter) ⭐ 2,405 | 🐛 2 | 🌐 C | 📅 2026-06-06 - Scans all running processes, recognizes and dumps a variety of potentially malicious implants (replaced/implanted PEs, shellcodes, hooks, in-memory patches).
* [Brim](https://github.com/brimsec/brim) ⭐ 1,967 | 🐛 296 | 🌐 TypeScript | 📅 2026-08-22 - A desktop application to efficiently search large packet captures and Zeek logs
* [Splunk Security Content](https://github.com/splunk/security_content) ⭐ 1,693 | 🐛 14 | 🌐 Python | 📅 2026-09-16 Splunk-curated detection content that can easily be used accross many SIEMs (see Uncoder Rule Converter.)
...
* [VAST](https://github.com/tenzir/vast) ⭐ 758 | 🐛 0 | 🌐 C++ | 📅 2026-09-15 - A network telemetry engine for data-driven security investigations.
...
* [osquery](https://osquery.io) ([github](https://github.com/osquery/osquery) ⭐ 23,577 | 🐛 650 | 🌐 C++ | 📅 2026-09-16) - SQL powered operating system instrumentation, monitoring, and analytics
* [WAZUH](https://github.com/wazuh/wazuh) ⭐ 16,906 | 🐛 3,105 | 🌐 C++ | 📅 2026-09-17 - An open-source security platform
...
* [Velociraptor](https://github.com/Velocidex/velociraptor) ⭐ 4,253 | 🐛 81 | 🌐 Go | 📅 2026-09-16 - Endpoint visibility and collection tool
* [Sysmon for Linux](https://github.com/Sysinternals/SysmonForLinux) ⭐ 2,158 | 🐛 41 | 🌐 C | 📅 2026-09-14
...
* [auditd configuration](https://github.com/Neo23x0/auditd) ⭐ 1,939 | 🐛 18 | 🌐 Shell | 📅 2026-05-04
...
* [ntopng](https://github.com/ntop/ntopng) ⭐ 8,171 | 🐛 297 | 🌐 Lua | 📅 2026-09-17 - A web-based network traffic monitoring tool
* [Zeek](https://github.com/zeek/zeek) ⭐ 7,965 | 🐛 258 | 🌐 C++ | 📅 2026-09-16 (formerly Bro) - A network security monitoring tool
* [Arkime](https://github.com/arkime/arkime) ⭐ 7,470 | 🐛 38 | 🌐 C | 📅 2026-09-16) - A large scale and open source full packet capture and search tool
...
* [Recog](https://github.com/rapid7/recog) ⭐ 793 | 🐛 29 | 🌐 Ruby | 📅 2026-09-16 - A framework for identifying products, services, operating systems, and hardware by matching fingerprints against data returned from various network probes
...
* [Sigma](https://github.com/SigmaHQ/sigma) ⭐ 11,050 | 🐛 211 | 🌐 Python | 📅 2026-09-15 - Generic Signature Format for SIEM Systems
* [ThreatHunter-Playbook](https://github.com/OTRF/ThreatHunter-Playbook) ⭐ 4,665 | 🐛 6 | 🌐 Python | 📅 2026-01-12 - A community-driven, open-source project to share detection logic, adversary tradecraft and resources to make detection development more efficient.
* [Awesome YARA Rules](https://github.com/InQuest/awesome-yara#rules) ⭐ 4,271 | 🐛 2 | 📅 2026-06-15
* [Elastic Detection Rules](https://github.com/elastic/detection-rules) ⭐ 2,699 | 🐛 237 | 🌐 Python | 📅 2026-09-17
...
* [Sublime Detection Rules](https://github.com/sublime-security/sublime-rules) ⭐ 374 | 🐛 85 | 🌐 YAML | 📅 2026-09-17 - Email attack detection, response, and hunting rules.
...
* [theZoo](https://github.com/ytisf/theZoo) ⭐ 13,387 | 🐛 88 | 🌐 Python | 📅 2026-09-14 - A repository of LIVE malwares
* [EVTX-ATTACK-SAMPLES](https://github.com/sbousseaden/EVTX-ATTACK-SAMPLES) ⭐ 2,627 | 🐛 5 | 🌐 HTML | 📅 2023-01-24 - A repo of Windows event samples (EVTX) associated with ATT\&CK techniques ([EVTX-ATT\&CK Sheet](https://docs.google.com/spreadsheets/d/12V5T9j6Fi3JSmMpAsMwovnWqRFKzzI9l2iXS5dEsnrs/edit#gid=164587082)).
...
* [attack\_data](https://github.com/splunk/attack_data) ⭐ 818 | 🐛 5 | 🌐 Python | 📅 2026-09-17 - A repository of curated datasets from various attacks.
...
* [ThreatHunter-Playbook](https://github.com/Cyb3rWard0g/ThreatHunter-Playbook) ⭐ 4,665 | 🐛 6 | 🌐 Python | 📅 2026-01-12 - A Threat hunter's playbook to aid the development of techniques and hypothesis for hunting campaigns.
...
* [The ThreatHunting Project](https://github.com/ThreatHuntingProject/ThreatHunting) ⭐ 1,891 | 🐛 7 | 📅 2021-11-17 - A great [collection of hunts](https://github.com/ThreatHuntingProject/ThreatHunting/tree/master/hunts) ⭐ 1,891 | 🐛 7 | 📅 2021-11-17 and threat hunting resources.
...
* [Alerting and Detection Strategies Framework](https://github.com/palantir/alerting-detection-strategy-framework) ⭐ 903 | 🐛 3 | 📅 2025-09-08 - A framework for developing alerting and detection strategies.
* [Open Cybersecurity Schema Framework (OCSF)](https://github.com/ocsf/ocsf-schema) ⭐ 891 | 🐛 171 | 📅 2026-09-15 -  A framework for creating schemas and it also delivers a cybersecurity event schema built with the framework ([schema browser](https://schema.ocsf.io/)).
...
* [Awesome Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,198 | 🐛 25 | 📅 2024-06-07
* [Awesome Honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,561 | 🐛 26 | 🌐 Python | 📅 2026-06-01
* [Awesome Incident Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,392 | 🐛 82 | 📅 2026-07-15
...
* [DetectionLab](https://github.com/clong/DetectionLab/) ⭐ 5,024 | 🐛 42 | 🌐 HTML | 📅 2024-07-06 - Vagrant & Packer scripts to build a lab environment complete with security tooling and logging best practices.
* [HELK](https://github.com/Cyb3rWard0g/HELK) ⭐ 3,928 | 🐛 60 | 🌐 Jupyter Notebook | 📅 2024-06-01 - A Hunting ELK (Elasticsearch, Logstash, Kibana) with advanced analytic capabilities.
* [attack\_range](https://github.com/splunk/attack_range) ⭐ 2,558 | 🐛 21 | 🌐 Python | 📅 2026-09-13 - A tool that allows you to create vulnerable instrumented local or cloud environments to simulate attacks against and collect the data into Splunk.
...
* [Atomic Red Team](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,547 | 🐛 33 | 🌐 C | 📅 2026-09-14 - Small and highly portable detection tests mapped to the Mitre ATT\&CK Framework.
...
* [MITRE CALDERA](https://github.com/mitre/caldera) ⭐ 7,270 | 🐛 73 | 🌐 Python | 📅 2026-08-27 - An automated adversary emulation system that performs post-compromise adversarial behavior within Windows Enterprise networks.
...
* [Splunk Attack Range](https://github.com/splunk/attack_range) ⭐ 2,558 | 🐛 21 | 🌐 Python | 📅 2026-09-13 - A tool that allows you to create vulnerable instrumented local or cloud environments to simulate attacks against and collect the data into Splunk.
...
* [Awesome Red Teaming](https://github.com/yeyintminthuhtut/Awesome-Red-Teaming) ⭐ 8,094 | 🐛 19 | 📅 2023-12-28 - A list of awesome red teaming resources
...
* [adversary\_emulation\_library](https://github.com/center-for-threat-informed-defense/adversary_emulation_library) ⭐ 2,165 | 🐛 40 | 🌐 C | 📅 2025-05-28 - An open library of adversary emulation plans designed to empower organizations to test their defenses based on real-world TTPs.
