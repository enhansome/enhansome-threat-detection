...
* [YARA](https://github.com/virustotal/yara) ⭐ 9,846 | 🐛 171 | 🌐 C | 📅 2026-08-25 - The pattern matching swiss knife
* [Dispatch](https://github.com/Netflix/dispatch) ⚠️ Archived - An open-source crisis management orchestration framework
* [Capa](https://github.com/fireeye/capa) ⭐ 6,172 | 🐛 298 | 🌐 Python | 📅 2026-09-01 - An open-source tool to identify capabilities in executable files.
* [DetectionLab](https://github.com/clong/DetectionLab/) ⭐ 5,015 | 🐛 42 | 🌐 HTML | 📅 2024-07-06 - Vagrant & Packer scripts to build a lab environment complete with security tooling and logging best practices.
* [ProcMon for Linux](https://github.com/Sysinternals/ProcMon-for-Linux) ⭐ 4,733 | 🐛 33 | 🌐 C | 📅 2026-05-07
* [Intel Owl](https://github.com/intelowlproject/IntelOwl) ⭐ 4,699 | 🐛 73 | 🌐 Python | 📅 2026-09-03 - An Open Source Intelligence, or OSINT solution to get threat intelligence data about a specific file, an IP or a domain from a single API at scale.
...
* [MITRE ATT\&CK Navigator](https://mitre.github.io/attack-navigator/enterprise/) ([source code](https://github.com/mitre-attack/attack-navigator) ⭐ 2,454 | 🐛 75 | 🌐 TypeScript | 📅 2026-09-05) - The ATT\&CK Navigator is designed to provide basic navigation and annotation of ATT\&CK matrices, something that people are already doing today in tools like Excel.
...
* [Splunk Security Content](https://github.com/splunk/security_content) ⭐ 1,683 | 🐛 12 | 🌐 Python | 📅 2026-09-05 Splunk-curated detection content that can easily be used accross many SIEMs (see Uncoder Rule Converter.)
...
* [Synthetic Adversarial Log Objects (SALO)](https://github.com/splunk/salo) ⭐ 93 | 🐛 2 | 🌐 Python | 📅 2024-01-11 - A framework for the generation of log events without the need for infrastructure or actions to initiate the event that causes a log event.
...
* [Shuffle](https://github.com/Shuffle/Shuffle) ⭐ 2,426 | 🐛 492 | 🌐 JavaScript | 📅 2026-09-05: A general purpose security automation platform.
* [Matano](https://github.com/matanolabs/matano) ⭐ 1,695 | 🐛 55 | 🌐 Rust | 📅 2025-01-08: An open source security lake platform (SIEM alternative) for threat hunting, detection and response on AWS. Matano lets you write advanced detections as code (using python) to correlate and alert on threats in realtime.
...
* [osquery](https://osquery.io) ([github](https://github.com/osquery/osquery) ⭐ 23,546 | 🐛 637 | 🌐 C++ | 📅 2026-08-25) - SQL powered operating system instrumentation, monitoring, and analytics
* [WAZUH](https://github.com/wazuh/wazuh) ⭐ 16,782 | 🐛 3,057 | 🌐 C++ | 📅 2026-09-05 - An open-source security platform
...
* [Velociraptor](https://github.com/Velocidex/velociraptor) ⭐ 4,236 | 🐛 73 | 🌐 Go | 📅 2026-09-05 - Endpoint visibility and collection tool
...
* [sysmon-config](https://github.com/SwiftOnSecurity/sysmon-config) ⭐ 5,637 | 🐛 82 | 📅 2024-07-03 - Sysmon configuration file template with default high-quality event tracing.
* [sysmon-modular](https://github.com/olafhartong/sysmon-modular) ⭐ 3,128 | 🐛 49 | 🌐 PowerShell | 📅 2026-08-31 - A repository of sysmon configuration modules. It also includes a [mapping](https://github.com/olafhartong/sysmon-modular/blob/master/attack_matrix/README.md) ⭐ 3,128 | 🐛 49 | 🌐 PowerShell | 📅 2026-08-31 of Sysmon configurations to MITRE ATT\&CK techniques.
...
* [ntopng](https://github.com/ntop/ntopng) ⭐ 8,139 | 🐛 312 | 🌐 Lua | 📅 2026-09-05 - A web-based network traffic monitoring tool
* [Zeek](https://github.com/zeek/zeek) ⭐ 7,942 | 🐛 255 | 🌐 C++ | 📅 2026-09-04 (formerly Bro) - A network security monitoring tool
...
* [Netcap](https://github.com/dreadl0ck/netcap) ⭐ 1,803 | 🐛 8 | 🌐 Go | 📅 2026-09-06 - A framework for secure and scalable network traffic analysis
...
* [JARM](https://github.com/salesforce/jarm) ⭐ 1,319 | 🐛 15 | 🌐 Python | 📅 2026-08-13 - An active Transport Layer Security (TLS) server fingerprinting tool.
...
* [Sigma](https://github.com/SigmaHQ/sigma) ⭐ 10,989 | 🐛 196 | 🌐 Python | 📅 2026-09-03 - Generic Signature Format for SIEM Systems
...
* [Elastic Detection Rules](https://github.com/elastic/detection-rules) ⭐ 2,698 | 🐛 246 | 🌐 Python | 📅 2026-09-05
...
* [Sublime Detection Rules](https://github.com/sublime-security/sublime-rules) ⭐ 373 | 🐛 105 | 🌐 YAML | 📅 2026-09-06 - Email attack detection, response, and hunting rules.
...
* [theZoo](https://github.com/ytisf/theZoo) ⭐ 13,362 | 🐛 89 | 🌐 Python | 📅 2026-07-24 - A repository of LIVE malwares
* [EVTX-ATTACK-SAMPLES](https://github.com/sbousseaden/EVTX-ATTACK-SAMPLES) ⭐ 2,624 | 🐛 5 | 🌐 HTML | 📅 2023-01-24 - A repo of Windows event samples (EVTX) associated with ATT\&CK techniques ([EVTX-ATT\&CK Sheet](https://docs.google.com/spreadsheets/d/12V5T9j6Fi3JSmMpAsMwovnWqRFKzzI9l2iXS5dEsnrs/edit#gid=164587082)).
...
* [attack\_data](https://github.com/splunk/attack_data) ⭐ 811 | 🐛 3 | 🌐 Python | 📅 2026-09-03 - A repository of curated datasets from various attacks.
...
* [Open Cybersecurity Schema Framework (OCSF)](https://github.com/ocsf/ocsf-schema) ⭐ 888 | 🐛 168 | 📅 2026-09-04 -  A framework for creating schemas and it also delivers a cybersecurity event schema built with the framework ([schema browser](https://schema.ocsf.io/)).
...
* [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,831 | 🐛 322 | 📅 2026-01-11
* [Awesome Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,181 | 🐛 25 | 📅 2024-06-07
* [Awesome Honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,547 | 🐛 22 | 🌐 Python | 📅 2026-06-01
* [Awesome Incident Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,373 | 🐛 78 | 📅 2026-07-15
* [Awesome Forensics](https://github.com/cugu/awesome-forensics) ⭐ 5,176 | 🐛 10 | 📅 2026-09-05
...
* [Atomic Red Team](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,490 | 🐛 31 | 🌐 C | 📅 2026-09-05 - Small and highly portable detection tests mapped to the Mitre ATT\&CK Framework.
...
* [MITRE CALDERA](https://github.com/mitre/caldera) ⭐ 7,240 | 🐛 71 | 🌐 Python | 📅 2026-08-27 - An automated adversary emulation system that performs post-compromise adversarial behavior within Windows Enterprise networks.
* [Infection Monkey](https://github.com/guardicore/monkey) ⭐ 7,085 | 🐛 240 | 🌐 Python | 📅 2025-05-01 - An open source Breach and Attack Simulation (BAS) tool that assesses the resiliency of private and public cloud environments to post-breach attacks and lateral movement.
...
* [Red Teaming/Adversary Simulation Toolkit](https://github.com/infosecn1nja/Red-Teaming-Toolkit) ⭐ 10,688 | 🐛 8 | 📅 2026-05-07 - A collection of open source and commercial tools that aid in red team operations.
