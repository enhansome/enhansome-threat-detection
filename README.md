...
* [YARA](https://github.com/virustotal/yara) ⭐ 9,845 | 🐛 170 | 🌐 C | 📅 2026-08-25 - The pattern matching swiss knife
* [Dispatch](https://github.com/Netflix/dispatch) ⚠️ Archived - An open-source crisis management orchestration framework
* [Capa](https://github.com/fireeye/capa) ⭐ 6,161 | 🐛 297 | 🌐 Python | 📅 2026-08-28 - An open-source tool to identify capabilities in executable files.
...
* [ProcMon for Linux](https://github.com/Sysinternals/ProcMon-for-Linux) ⭐ 4,733 | 🐛 33 | 🌐 C | 📅 2026-05-07
* [Intel Owl](https://github.com/intelowlproject/IntelOwl) ⭐ 4,689 | 🐛 76 | 🌐 Python | 📅 2026-09-01 - An Open Source Intelligence, or OSINT solution to get threat intelligence data about a specific file, an IP or a domain from a single API at scale.
...
* [MITRE ATT\&CK Navigator](https://mitre.github.io/attack-navigator/enterprise/) ([source code](https://github.com/mitre-attack/attack-navigator) ⭐ 2,451 | 🐛 74 | 🌐 TypeScript | 📅 2026-08-28) - The ATT\&CK Navigator is designed to provide basic navigation and annotation of ATT\&CK matrices, something that people are already doing today in tools like Excel.
* [DeepBlueCLI](https://github.com/sans-blue-team/DeepBlueCLI) ⭐ 2,429 | 🐛 13 | 🌐 PowerShell | 📅 2023-10-14 - A PowerShell Module for Hunt Teaming via Windows Event Logs
...
* [Splunk Security Content](https://github.com/splunk/security_content) ⭐ 1,681 | 🐛 16 | 🌐 Python | 📅 2026-09-01 Splunk-curated detection content that can easily be used accross many SIEMs (see Uncoder Rule Converter.)
...
* [VAST](https://github.com/tenzir/vast) ⭐ 758 | 🐛 0 | 🌐 C++ | 📅 2026-09-01 - A network telemetry engine for data-driven security investigations.
...
* [StreamAlert](https://github.com/airbnb/streamalert) ⭐ 2,888 | 🐛 90 | 🌐 Python | 📅 2023-10-23 - A serverless, realtime data analysis framework which empowers you to ingest, analyze, and alert on data from any environment, using datasources and alerting logic you define
* [Shuffle](https://github.com/Shuffle/Shuffle) ⭐ 2,423 | 🐛 491 | 🌐 JavaScript | 📅 2026-09-01: A general purpose security automation platform.
...
* [Substation](https://github.com/brexhq/substation) ⭐ 405 | 🐛 3 | 🌐 Go | 📅 2026-01-20 - A cloud native data pipeline and transformation toolkit for security teams.
...
* [osquery](https://osquery.io) ([github](https://github.com/osquery/osquery) ⭐ 23,531 | 🐛 633 | 🌐 C++ | 📅 2026-08-25) - SQL powered operating system instrumentation, monitoring, and analytics
* [WAZUH](https://github.com/wazuh/wazuh) ⭐ 16,732 | 🐛 3,023 | 🌐 C++ | 📅 2026-09-01 - An open-source security platform
* [Sysdig](https://github.com/draios/sysdig) ⭐ 8,292 | 🐛 116 | 🌐 C++ | 📅 2026-04-13 - A tool for deep Linux system visibility, with native support for containers. Think about sysdig as strace + tcpdump + htop + iftop + lsof + ...awesome sauce
* [OSSEC](https://github.com/ossec/ossec-hids) ⭐ 5,052 | 🐛 124 | 🌐 C | 📅 2026-08-26 - An open-source Host-based Intrusion Detection System (HIDS)
* [Velociraptor](https://github.com/Velocidex/velociraptor) ⭐ 4,223 | 🐛 76 | 🌐 Go | 📅 2026-08-25 - Endpoint visibility and collection tool
* [Sysmon for Linux](https://github.com/Sysinternals/SysmonForLinux) ⭐ 2,154 | 🐛 42 | 🌐 C | 📅 2026-07-13
...
* [sysmon-config](https://github.com/SwiftOnSecurity/sysmon-config) ⭐ 5,635 | 🐛 82 | 📅 2024-07-03 - Sysmon configuration file template with default high-quality event tracing.
* [sysmon-modular](https://github.com/olafhartong/sysmon-modular) ⭐ 3,124 | 🐛 49 | 🌐 PowerShell | 📅 2026-08-31 - A repository of sysmon configuration modules. It also includes a [mapping](https://github.com/olafhartong/sysmon-modular/blob/master/attack_matrix/README.md) ⭐ 3,124 | 🐛 49 | 🌐 PowerShell | 📅 2026-08-31 of Sysmon configurations to MITRE ATT\&CK techniques.
* [auditd configuration](https://github.com/Neo23x0/auditd) ⭐ 1,904 | 🐛 18 | 🌐 Shell | 📅 2026-05-04
...
* [ntopng](https://github.com/ntop/ntopng) ⭐ 8,125 | 🐛 321 | 🌐 Lua | 📅 2026-09-01 - A web-based network traffic monitoring tool
* [Zeek](https://github.com/zeek/zeek) ⭐ 7,927 | 🐛 253 | 🌐 C++ | 📅 2026-09-01 (formerly Bro) - A network security monitoring tool
* [Arkime](https://github.com/arkime/arkime) ⭐ 7,459 | 🐛 37 | 🌐 C | 📅 2026-08-31) - A large scale and open source full packet capture and search tool
* [Snort](https://snort.org) ([github](https://github.com/snort3/snort3) ⭐ 3,409 | 🐛 78 | 🌐 C++ | 📅 2026-04-23) - A network intrusion detection tool
* [Netcap](https://github.com/dreadl0ck/netcap) ⭐ 1,804 | 🐛 3 | 🌐 Go | 📅 2026-08-31 - A framework for secure and scalable network traffic analysis
...
* [JARM](https://github.com/salesforce/jarm) ⭐ 1,316 | 🐛 15 | 🌐 Python | 📅 2026-08-13 - An active Transport Layer Security (TLS) server fingerprinting tool.
...
* [Sigma](https://github.com/SigmaHQ/sigma) ⭐ 10,966 | 🐛 213 | 🌐 Python | 📅 2026-09-01 - Generic Signature Format for SIEM Systems
* [ThreatHunter-Playbook](https://github.com/OTRF/ThreatHunter-Playbook) ⭐ 4,649 | 🐛 6 | 🌐 Python | 📅 2026-01-12 - A community-driven, open-source project to share detection logic, adversary tradecraft and resources to make detection development more efficient.
* [Awesome YARA Rules](https://github.com/InQuest/awesome-yara#rules) ⭐ 4,265 | 🐛 2 | 📅 2026-06-15
* [Elastic Detection Rules](https://github.com/elastic/detection-rules) ⭐ 2,698 | 🐛 235 | 🌐 Python | 📅 2026-08-31
...
* [Sublime Detection Rules](https://github.com/sublime-security/sublime-rules) ⭐ 372 | 🐛 95 | 🌐 YAML | 📅 2026-09-01 - Email attack detection, response, and hunting rules.
...
* [theZoo](https://github.com/ytisf/theZoo) ⭐ 13,340 | 🐛 89 | 🌐 Python | 📅 2026-07-24 - A repository of LIVE malwares
* [EVTX-ATTACK-SAMPLES](https://github.com/sbousseaden/EVTX-ATTACK-SAMPLES) ⭐ 2,617 | 🐛 5 | 🌐 HTML | 📅 2023-01-24 - A repo of Windows event samples (EVTX) associated with ATT\&CK techniques ([EVTX-ATT\&CK Sheet](https://docs.google.com/spreadsheets/d/12V5T9j6Fi3JSmMpAsMwovnWqRFKzzI9l2iXS5dEsnrs/edit#gid=164587082)).
* [Mordor](https://github.com/Cyb3rWard0g/mordor) ⭐ 1,809 | 🐛 13 | 🌐 PowerShell | 📅 2024-03-20 - Pre-recorded security events generated by simulated adversarial techniques in the form of JavaScript Object Notation (JSON) files. The data is categorized by platforms, adversary groups, tactics and techniques defined by the Mitre ATT\&CK Framework.
...
* [attack\_data](https://github.com/splunk/attack_data) ⭐ 810 | 🐛 3 | 🌐 Python | 📅 2026-08-31 - A repository of curated datasets from various attacks.
* [Boss of the SOC (BOTS) Dataset Version 3](https://github.com/splunk/botsv3) ⭐ 487 | 🐛 0 | 📅 2020-06-18
...
* [ThreatHunter-Playbook](https://github.com/Cyb3rWard0g/ThreatHunter-Playbook) ⭐ 4,649 | 🐛 6 | 🌐 Python | 📅 2026-01-12 - A Threat hunter's playbook to aid the development of techniques and hypothesis for hunting campaigns.
* [Awesome YARA](https://github.com/InQuest/awesome-yara) ⭐ 4,265 | 🐛 2 | 📅 2026-06-15 - A curated list of awesome YARA rules, tools, and resources
...
* [Open Cybersecurity Schema Framework (OCSF)](https://github.com/ocsf/ocsf-schema) ⭐ 885 | 🐛 167 | 📅 2026-08-29 -  A framework for creating schemas and it also delivers a cybersecurity event schema built with the framework ([schema browser](https://schema.ocsf.io/)).
...
* [The osquery Extensions Skunkworks Project](https://github.com/trailofbits/presentations/tree/master/Osquery%20Extensions) ⭐ 1,884 | 🐛 3 | 🌐 Python | 📅 2026-08-31
...
* [msticpy](https://github.com/microsoft/msticpy) ⭐ 1,998 | 🐛 12 | 🌐 Python | 📅 2026-08-13 - A library for InfoSec investigation and hunting in Jupyter Notebooks.
...
* [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,817 | 🐛 320 | 📅 2026-01-11
* [Awesome Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,173 | 🐛 25 | 📅 2024-06-07
* [Awesome Honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,540 | 🐛 23 | 🌐 Python | 📅 2026-06-01
* [Awesome Incident Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,364 | 🐛 76 | 📅 2026-07-15
* [Awesome Forensics](https://github.com/cugu/awesome-forensics) ⭐ 5,170 | 🐛 9 | 📅 2026-08-23
* [Awesome YARA](https://github.com/InQuest/awesome-yara) ⭐ 4,265 | 🐛 2 | 📅 2026-06-15
...
* [DetectionLab](https://github.com/clong/DetectionLab/) ⭐ 5,011 | 🐛 42 | 🌐 HTML | 📅 2024-07-06 - Vagrant & Packer scripts to build a lab environment complete with security tooling and logging best practices.
* [HELK](https://github.com/Cyb3rWard0g/HELK) ⭐ 3,930 | 🐛 60 | 🌐 Jupyter Notebook | 📅 2024-06-01 - A Hunting ELK (Elasticsearch, Logstash, Kibana) with advanced analytic capabilities.
* [attack\_range](https://github.com/splunk/attack_range) ⭐ 2,547 | 🐛 20 | 🌐 Python | 📅 2026-08-27 - A tool that allows you to create vulnerable instrumented local or cloud environments to simulate attacks against and collect the data into Splunk.
...
* [Atomic Red Team](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,474 | 🐛 32 | 🌐 C | 📅 2026-08-31 - Small and highly portable detection tests mapped to the Mitre ATT\&CK Framework.
...
* [MITRE CALDERA](https://github.com/mitre/caldera) ⭐ 7,231 | 🐛 69 | 🌐 Python | 📅 2026-08-27 - An automated adversary emulation system that performs post-compromise adversarial behavior within Windows Enterprise networks.
* [Infection Monkey](https://github.com/guardicore/monkey) ⭐ 7,082 | 🐛 240 | 🌐 Python | 📅 2025-05-01 - An open source Breach and Attack Simulation (BAS) tool that assesses the resiliency of private and public cloud environments to post-breach attacks and lateral movement.
* [APTSimulator](https://github.com/NextronSystems/APTSimulator) ⭐ 2,765 | 🐛 4 | 🌐 Batchfile | 📅 2025-09-23 - A Windows Batch script that uses a set of tools and output files to make a system look as if it was compromised.
* [Splunk Attack Range](https://github.com/splunk/attack_range) ⭐ 2,547 | 🐛 20 | 🌐 Python | 📅 2026-08-27 - A tool that allows you to create vulnerable instrumented local or cloud environments to simulate attacks against and collect the data into Splunk.
* [SharpShooter](https://github.com/mdsecactivebreach/SharpShooter) ⭐ 1,988 | 🐛 23 | 🌐 VBA | 📅 2024-08-21 - Payload Generation Framework.
* [Network Flight Simulator](https://github.com/alphasoc/flightsim) ⭐ 1,364 | 🐛 24 | 🌐 Go | 📅 2024-04-04 - flightsim is a lightweight utility used to generate malicious network traffic and help security teams to evaluate security controls and network visibility.
* [RedHunt-OS](https://github.com/redhuntlabs/RedHunt-OS) ⭐ 1,318 | 🐛 7 | 📅 2025-01-22 - A Virtual Machine for Adversary Emulation and Threat Hunting. RedHunt aims to be a one stop shop for all your threat emulation and threat hunting needs by integrating attacker's arsenal as well as defender's toolkit to actively identify the threats in your environment.
...
* [Red Teaming/Adversary Simulation Toolkit](https://github.com/infosecn1nja/Red-Teaming-Toolkit) ⭐ 10,664 | 🐛 8 | 📅 2026-05-07 - A collection of open source and commercial tools that aid in red team operations.
* [Awesome Red Teaming](https://github.com/yeyintminthuhtut/Awesome-Red-Teaming) ⭐ 8,078 | 🐛 19 | 📅 2023-12-28 - A list of awesome red teaming resources
* [Red-Team Infrastructure Wiki](https://github.com/bluscreenofjeff/Red-Team-Infrastructure-Wiki) ⭐ 4,522 | 🐛 0 | 📅 2025-10-01 - Wiki to collect Red Team infrastructure hardening resources.
* [adversary\_emulation\_library](https://github.com/center-for-threat-informed-defense/adversary_emulation_library) ⭐ 2,157 | 🐛 40 | 🌐 C | 📅 2025-05-28 - An open library of adversary emulation plans designed to empower organizations to test their defenses based on real-world TTPs.
