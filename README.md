...
* [YARA](https://github.com/virustotal/yara) ⭐ 9,875 | 🐛 172 | 🌐 C | 📅 2026-08-25 - The pattern matching swiss knife
* [Dispatch](https://github.com/Netflix/dispatch) ⚠️ Archived - An open-source crisis management orchestration framework
* [Capa](https://github.com/fireeye/capa) ⭐ 6,190 | 🐛 307 | 🌐 Python | 📅 2026-09-14 - An open-source tool to identify capabilities in executable files.
* [DetectionLab](https://github.com/clong/DetectionLab/) ⭐ 5,025 | 🐛 42 | 🌐 HTML | 📅 2024-07-06 - Vagrant & Packer scripts to build a lab environment complete with security tooling and logging best practices.
* [ProcMon for Linux](https://github.com/Sysinternals/ProcMon-for-Linux) ⭐ 4,739 | 🐛 33 | 🌐 C | 📅 2026-09-14
* [Intel Owl](https://github.com/intelowlproject/IntelOwl) ⭐ 4,724 | 🐛 68 | 🌐 Python | 📅 2026-09-18 - An Open Source Intelligence, or OSINT solution to get threat intelligence data about a specific file, an IP or a domain from a single API at scale.
...
* [MITRE ATT\&CK Navigator](https://mitre.github.io/attack-navigator/enterprise/) ([source code](https://github.com/mitre-attack/attack-navigator) ⭐ 2,463 | 🐛 79 | 🌐 TypeScript | 📅 2026-09-14) - The ATT\&CK Navigator is designed to provide basic navigation and annotation of ATT\&CK matrices, something that people are already doing today in tools like Excel.
...
* [hollows\_hunter](https://github.com/hasherezade/hollows_hunter) ⭐ 2,407 | 🐛 2 | 🌐 C | 📅 2026-06-06 - Scans all running processes, recognizes and dumps a variety of potentially malicious implants (replaced/implanted PEs, shellcodes, hooks, in-memory patches).
...
* [Splunk Security Content](https://github.com/splunk/security_content) ⭐ 1,695 | 🐛 15 | 🌐 Python | 📅 2026-09-18 Splunk-curated detection content that can easily be used accross many SIEMs (see Uncoder Rule Converter.)
...
* [VAST](https://github.com/tenzir/vast) ⭐ 759 | 🐛 0 | 🌐 C++ | 📅 2026-09-18 - A network telemetry engine for data-driven security investigations.
...
* [EQL](https://github.com/endgameinc/eql) ⭐ 227 | 🐛 6 | 🌐 Python | 📅 2026-08-07 - Event Query Language
  * [EQLLib](https://github.com/endgameinc/eqllib) ⭐ 170 | 🐛 7 | 🌐 Python | 📅 2021-01-20 - The Event Query Language Analytics Library (eqllib) is a library of event based analytics, written in EQL to detect adversary behaviors identified in MITRE ATT\&CK™.
...
* [Shuffle](https://github.com/Shuffle/Shuffle) ⭐ 2,441 | 🐛 492 | 🌐 JavaScript | 📅 2026-09-18: A general purpose security automation platform.
...
* [Sublime](https://github.com/sublime-security/sublime-platform) ⭐ 269 | 🐛 11 | 🌐 Shell | 📅 2026-09-17: An open platform for detection, response, and threat hunting in email environments. Sublime lets you write advanced detections as code to alert and remediate threats like phishing in real-time.

### Endpoint Monitoring

* [osquery](https://osquery.io) ([github](https://github.com/osquery/osquery) ⭐ 23,581 | 🐛 609 | 🌐 C++ | 📅 2026-09-17) - SQL powered operating system instrumentation, monitoring, and analytics
* [WAZUH](https://github.com/wazuh/wazuh) ⭐ 16,931 | 🐛 3,098 | 🌐 C++ | 📅 2026-09-19 - An open-source security platform
* [Sysdig](https://github.com/draios/sysdig) ⭐ 8,294 | 🐛 117 | 🌐 C++ | 📅 2026-04-13 - A tool for deep Linux system visibility, with native support for containers. Think about sysdig as strace + tcpdump + htop + iftop + lsof + ...awesome sauce
* [OSSEC](https://github.com/ossec/ossec-hids) ⭐ 5,057 | 🐛 125 | 🌐 C | 📅 2026-09-17 - An open-source Host-based Intrusion Detection System (HIDS)
* [Velociraptor](https://github.com/Velocidex/velociraptor) ⭐ 4,262 | 🐛 72 | 🌐 Go | 📅 2026-09-18 - Endpoint visibility and collection tool
...
* [sysmon-config](https://github.com/SwiftOnSecurity/sysmon-config) ⭐ 5,650 | 🐛 82 | 📅 2024-07-03 - Sysmon configuration file template with default high-quality event tracing.
* [sysmon-modular](https://github.com/olafhartong/sysmon-modular) ⭐ 3,132 | 🐛 49 | 🌐 Go | 📅 2026-09-18 - A repository of sysmon configuration modules. It also includes a [mapping](https://github.com/olafhartong/sysmon-modular/blob/master/attack_matrix/README.md) ⭐ 3,132 | 🐛 49 | 🌐 Go | 📅 2026-09-18 of Sysmon configurations to MITRE ATT\&CK techniques.
* [auditd configuration](https://github.com/Neo23x0/auditd) ⭐ 1,942 | 🐛 19 | 🌐 Shell | 📅 2026-05-04
...
* [ntopng](https://github.com/ntop/ntopng) ⭐ 8,182 | 🐛 305 | 🌐 Lua | 📅 2026-09-18 - A web-based network traffic monitoring tool
* [Zeek](https://github.com/zeek/zeek) ⭐ 7,972 | 🐛 259 | 🌐 C++ | 📅 2026-09-19 (formerly Bro) - A network security monitoring tool
* [Arkime](https://github.com/arkime/arkime) ⭐ 7,471 | 🐛 38 | 🌐 C | 📅 2026-09-18) - A large scale and open source full packet capture and search tool
* [Snort](https://snort.org) ([github](https://github.com/snort3/snort3) ⭐ 3,424 | 🐛 80 | 🌐 C++ | 📅 2026-04-23) - A network intrusion detection tool
* [Netcap](https://github.com/dreadl0ck/netcap) ⭐ 1,802 | 🐛 11 | 🌐 Go | 📅 2026-09-16 - A framework for secure and scalable network traffic analysis
...
* [Recog](https://github.com/rapid7/recog) ⭐ 795 | 🐛 29 | 🌐 Ruby | 📅 2026-09-16 - A framework for identifying products, services, operating systems, and hardware by matching fingerprints against data returned from various network probes
...
* [GQUIC Protocol Analyzer for Zeek](https://github.com/salesforce/GQUIC_Protocol_Analyzer) ⭐ 83 | 🐛 3 | 🌐 Zeek | 📅 2026-08-13
...
* [Sublime Platform](https://github.com/sublime-security/sublime-platform) ⭐ 269 | 🐛 11 | 🌐 Shell | 📅 2026-09-17 - An email threat detection engine

## Detection Rules

* [Sigma](https://github.com/SigmaHQ/sigma) ⭐ 11,063 | 🐛 215 | 🌐 Python | 📅 2026-09-15 - Generic Signature Format for SIEM Systems
* [ThreatHunter-Playbook](https://github.com/OTRF/ThreatHunter-Playbook) ⭐ 4,668 | 🐛 6 | 🌐 Python | 📅 2026-01-12 - A community-driven, open-source project to share detection logic, adversary tradecraft and resources to make detection development more efficient.
* [Awesome YARA Rules](https://github.com/InQuest/awesome-yara#rules) ⭐ 4,274 | 🐛 1 | 📅 2026-06-15
* [Elastic Detection Rules](https://github.com/elastic/detection-rules) ⭐ 2,699 | 🐛 240 | 🌐 Python | 📅 2026-09-18
...
* [Sublime Detection Rules](https://github.com/sublime-security/sublime-rules) ⭐ 375 | 🐛 75 | 🌐 YAML | 📅 2026-09-19 - Email attack detection, response, and hunting rules.
...
* [theZoo](https://github.com/ytisf/theZoo) ⭐ 13,396 | 🐛 89 | 🌐 Python | 📅 2026-09-14 - A repository of LIVE malwares
...
* [attack\_data](https://github.com/splunk/attack_data) ⭐ 818 | 🐛 2 | 🌐 Python | 📅 2026-09-18 - A repository of curated datasets from various attacks.
...
* [PCAP-ATTACK](https://github.com/sbousseaden/PCAP-ATTACK) ⭐ 374 | 🐛 2 | 📅 2021-04-29 - A repo of PCAP samples for different ATT\&CK techniques.
...
* [ThreatHunter-Playbook](https://github.com/Cyb3rWard0g/ThreatHunter-Playbook) ⭐ 4,668 | 🐛 6 | 🌐 Python | 📅 2026-01-12 - A Threat hunter's playbook to aid the development of techniques and hypothesis for hunting campaigns.
* [Awesome YARA](https://github.com/InQuest/awesome-yara) ⭐ 4,274 | 🐛 1 | 📅 2026-06-15 - A curated list of awesome YARA rules, tools, and resources
...
* [Alerting and Detection Strategies Framework](https://github.com/palantir/alerting-detection-strategy-framework) ⭐ 906 | 🐛 3 | 📅 2025-09-08 - A framework for developing alerting and detection strategies.
* [Open Cybersecurity Schema Framework (OCSF)](https://github.com/ocsf/ocsf-schema) ⭐ 892 | 🐛 173 | 📅 2026-09-18 -  A framework for creating schemas and it also delivers a cybersecurity event schema built with the framework ([schema browser](https://schema.ocsf.io/)).
...
* [The osquery Extensions Skunkworks Project](https://github.com/trailofbits/presentations/tree/master/Osquery%20Extensions) ⭐ 1,893 | 🐛 4 | 🌐 Python | 📅 2026-09-18
...
* [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,867 | 🐛 336 | 📅 2026-01-11
* [Awesome Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,202 | 🐛 25 | 📅 2024-06-07
* [Awesome Honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,564 | 🐛 29 | 🌐 Python | 📅 2026-06-01
* [Awesome Incident Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,396 | 🐛 83 | 📅 2026-07-15
* [Awesome Forensics](https://github.com/cugu/awesome-forensics) ⭐ 5,186 | 🐛 13 | 📅 2026-09-05
...
* [DetectionLab](https://github.com/clong/DetectionLab/) ⭐ 5,025 | 🐛 42 | 🌐 HTML | 📅 2024-07-06 - Vagrant & Packer scripts to build a lab environment complete with security tooling and logging best practices.
* [HELK](https://github.com/Cyb3rWard0g/HELK) ⭐ 3,929 | 🐛 60 | 🌐 Jupyter Notebook | 📅 2024-06-01 - A Hunting ELK (Elasticsearch, Logstash, Kibana) with advanced analytic capabilities.
* [attack\_range](https://github.com/splunk/attack_range) ⭐ 2,559 | 🐛 21 | 🌐 Python | 📅 2026-09-13 - A tool that allows you to create vulnerable instrumented local or cloud environments to simulate attacks against and collect the data into Splunk.
...
* [Atomic Red Team](https://github.com/redcanaryco/atomic-red-team) ⭐ 12,559 | 🐛 31 | 🌐 C | 📅 2026-09-14 - Small and highly portable detection tests mapped to the Mitre ATT\&CK Framework.
...
* [MITRE CALDERA](https://github.com/mitre/caldera) ⭐ 7,278 | 🐛 73 | 🌐 Python | 📅 2026-08-27 - An automated adversary emulation system that performs post-compromise adversarial behavior within Windows Enterprise networks.
...
* [Splunk Attack Range](https://github.com/splunk/attack_range) ⭐ 2,559 | 🐛 21 | 🌐 Python | 📅 2026-09-13 - A tool that allows you to create vulnerable instrumented local or cloud environments to simulate attacks against and collect the data into Splunk.
* [SharpShooter](https://github.com/mdsecactivebreach/SharpShooter) ⭐ 1,988 | 🐛 23 | 🌐 VBA | 📅 2024-08-21 - Payload Generation Framework.
* [Network Flight Simulator](https://github.com/alphasoc/flightsim) ⭐ 1,366 | 🐛 24 | 🌐 Go | 📅 2024-04-04 - flightsim is a lightweight utility used to generate malicious network traffic and help security teams to evaluate security controls and network visibility.
* [RedHunt-OS](https://github.com/redhuntlabs/RedHunt-OS) ⭐ 1,320 | 🐛 7 | 📅 2025-01-22 - A Virtual Machine for Adversary Emulation and Threat Hunting. RedHunt aims to be a one stop shop for all your threat emulation and threat hunting needs by integrating attacker's arsenal as well as defender's toolkit to actively identify the threats in your environment.
...
* [Red Teaming/Adversary Simulation Toolkit](https://github.com/infosecn1nja/Red-Teaming-Toolkit) ⭐ 10,727 | 🐛 8 | 📅 2026-05-07 - A collection of open source and commercial tools that aid in red team operations.
* [Awesome Red Teaming](https://github.com/yeyintminthuhtut/Awesome-Red-Teaming) ⭐ 8,098 | 🐛 19 | 📅 2023-12-28 - A list of awesome red teaming resources
* [Red-Team Infrastructure Wiki](https://github.com/bluscreenofjeff/Red-Team-Infrastructure-Wiki) ⭐ 4,529 | 🐛 0 | 📅 2025-10-01 - Wiki to collect Red Team infrastructure hardening resources.
